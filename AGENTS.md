# Feed Transformer — Projectstatus voor Codex
...
├── AGENTS.md                 Dit bestand — projectstatus
├── input/
...
### 💡 Toekomstige ideeën
- Codex API-koppeling voor automatisch genereren van titels/beschrijvingen via LLM
